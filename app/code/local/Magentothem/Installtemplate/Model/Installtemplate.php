...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
        ...
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_sahara_digital5', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_sahara_digital5_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_sahara_digital5', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_sahara_digital5_home', 'default', 0);
    }
